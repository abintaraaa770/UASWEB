...
<body>
    ...
    <div class="container">
        <a class="navbar-brand text-white">My Daily Journal</a>
        <button
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-dark">
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item tn text-danger" href="index.php">Logout</a></li> 
                </ul>
            </li> 
        </ul>
        </div>
...
<!-- footer begin -->
    <footer class="text-center py-3 bg-black footer fixed-bottom text-white">
    <div>_abintaraa &copy; 2024</div>
    </footer>
    <!-- footer end -->
    <script
